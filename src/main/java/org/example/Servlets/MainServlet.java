...
//            UserProfile user = userService.getUserByLogin(getLoginCookie(cookies));
            if (user != null) {
                String currentPath = req.getParameter("path");
                if (currentPath == null || !currentPath.startsWith("C:/homeFolder/" + user.getLogin())) {
                    currentPath = System.getProperty("os.name").toLowerCase().startsWith("win") ? "C:/homeFolder" : "/opt/tomcat/";
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        if(req.getParameter("exitBtn") != null) {
            UserCookies.addCookie(resp, "login", null);
            UserCookies.addCookie(resp, "password", null);
